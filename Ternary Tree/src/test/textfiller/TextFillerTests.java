...
public class TextFillerTests {
    ...
    // Each time you pass a test, you get a point! !
    ...
    public void textFill() {
        ...
        String result = tf.textFill("it");
        assertTrue(result.equals("it") || result.equals("item"));
        result = tf.textFill("go");
        assertTrue(result.equals("goat") || result.equals("goad"));
        result = tf.textFill("as");
        assertTrue(result.equals("as") || result.equals("ass"));
    }
    @Test
