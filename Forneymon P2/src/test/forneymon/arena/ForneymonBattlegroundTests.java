...
public class ForneymonBattlegroundTests {
    ...
    @Test
    public void releaseSpecies_t11() {
        fm1.collect(new Dampymon(1));
        fm1.collect(new Burnymon(2));
    ...
    @Test
    public void releaseSpecies_t12() {
        fm1.collect(new Dampymon(1));
        fm1.collect(new Burnymon(2));
        fm1.collect(new Leafymon(3));
        fm1.releaseSpecies("Dampymon");
    ...
    @Test
    public void releaseSpecies_t13() {
        fm1.collect(new Dampymon(1));
        fm1.collect(new Burnymon(2));
        fm1.collect(new Leafymon(3));
        fm1.collect(new Zappymon(2));
    ...
    @Test
    public void releaseSpecies_t41() {
        fm1.releaseSpecies("Dampymon");
        assertTrue(!fm1.containsSpecies("Dampymon"));
    }
    ...
    @Test
    public void getSpeciesIndexContainsSpecies_t11() {
        fm1.collect(new Dampymon(1));
        fm1.collect(new Burnymon(1));
        fm1.collect(new Dampymon(1));
        assertEquals(0, fm1.getSpeciesIndex("Dampymon"));
    ...
    @Test
    public void getSpeciesIndexContainsSpecies_t21() {
        fm1.collect(new Dampymon(1));
        fm1.collect(new Burnymon(2));
        fm1.collect(new Leafymon(3));
        fm1.collect(new Zappymon(2));
    ...
    @Test
    public void equals_t11() {
        LinkedForneymonagerie fm2 = new LinkedForneymonagerie();
        assertEquals(fm1, fm2);
    }
    @Test
    public void equals_t21() {
        fm1.collect(new Dampymon(1));
        fm1.collect(new Burnymon(1));
    ...
    @Test
    public void getMVP_t4() {
        assertEquals(null, fm1.getMVP());
    }
    @Test
    ...
    @Test
    public void rearrange_t9() {
        fm1.collect(new Dampymon(1));
        fm1.collect(new Burnymon(1));
        fm1.collect(new Leafymon(1));
        fm1.collect(new Zappymon(1));
        fm1.rearrange("Dampymon", 0);
        assertThrows(IllegalArgumentException.class, () -> fm1.rearrange("Zappymon", 9));
    }
